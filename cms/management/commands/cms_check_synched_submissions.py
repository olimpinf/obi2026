...
from cms.utils import cms_check_synched_submissions
...
class Command(BaseCommand):
    help = 'Synchronize cms submissions and participations'
    ...
    def handle(self, *args, **options):
        ...
        count = cms_check_synched_submissions(exam_descriptor)
