...
app_name = 'fase2'
urlpatterns = [
    path('prog/restrito/lista_desclassif', views.compet_lista_desclassif_prog, name='compet_lista_desclassif_prog'),
    ...
    path('ini/restrito/corretorfolhasrespostas_extra', views.corretorfolhasrespostas_extra, name='corretorfolhasrespostas_extra'),
    path('ini/restrito/corretorfolhasrespostas_adm', views.corretorfolhasrespostas_adm, name='corretorfolhasrespostas_adm'),
    ...
    #path('consulta_res', views.consulta_resultado, name='consulta_resultado'),
