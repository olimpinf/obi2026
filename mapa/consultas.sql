...
-- escolas com classificados, prog ou inic
\copy (select school_city,school_state, level_short_name, count(compet_id) from school, compet,level where level_id=compet_type and compet_school_id=school_id and compet_classif_fase2 group by school_city,school_state,level_short_name order by school_state, school_city, level_short_name) to 'total/escolas_classif.csv' CSV DELIMITER '|';

-- escolas com classificados prog
\copy (select school_city,school_state, level_short_name, count(compet_id) from school, compet,level where level_id=compet_type and compet_school_id=school_id and compet_classif_fase2 and compet_type in (3,4,5,6) group by school_city,school_state,level_short_name order by school_state, school_city, level_short_name) to 'prog/escolas_classif.csv' CSV DELIMITER '|';

-- escolas com classificados ini
\copy (select school_city,school_state, level_short_name, count(compet_id) from school, compet,level where level_id=compet_type and compet_school_id=school_id and compet_classif_fase2 and compet_type in (1,2,7) group by school_city,school_state,level_short_name order by school_state, school_city, level_short_name) to 'ini/escolas_classif.csv' CSV DELIMITER '|';
