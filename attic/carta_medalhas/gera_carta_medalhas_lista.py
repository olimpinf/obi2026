...
comm = '''select 
    ...
    compet_medal 
    from school,compet 
    where compet_school_id=school_id and school_ok and school_id in  (904, 227, 286, 1513, 1149, 532, 334, 1164, 2429)
...
cur_school_id = 0
f = open(f'cartas_medalhas.tex','w')
f.write(head_text)
...
os.system("pdflatex cartas_medalhas")
