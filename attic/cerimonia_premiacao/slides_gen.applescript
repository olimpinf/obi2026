...
set kYear to "2023"
set kObiEdition to "XXV"
set kIcMembers to {{"Prof. Dr. Rodolfo Jardim de Azevedo", "Ex-Diretor do Instituto de Computação da Unicamp\n\nEx-Reitor da UNIVESP - Universidade Virtual do Estado de São Paulo\n\nCo-Coordenador da OBI"}, {"Prof. Dr. Ricardo Anido", "Ex-Diretor do Instituto de  Computação da Unicamp\n\nCo-Coordenador da OBI", {"Prof. Dr. Lucas Francisco Wanner, Coordenador do curso de Engenharia de Computação do IC-Unicamp"}}}
...
tell application "Keynote"
	activate
	set thisDocument to ¬
		make new document with properties {document theme:theme "teste"}
	tell thisDocument
		-- cover
		...
		-- medals
		repeat with catEntry in {{"INICIAÇÃO NÍVEL 1", "i1"}, {"INICIAÇÃO NÍVEL 2", "i2"}, {"PROGRAMAÇÃO JÚNIOR", "pj"}, {"PROGRAMAÇÃO NÍVEL 1", "p1"}, {"PROGRAMAÇÃO NÍVEL 2", "p2"}}
