...
\newcommand\BackgroundPic{
  \put(12,110){
    \parbox[b][165mm]{105mm}{
      \vfill
      \centering
      \includegraphics[width=109mm,keepaspectratio]{FundoCrachaVerde.pdf}
      \vfill
    }
  }
}
...
\cracha{Luã}{Marcelo Muriana}{201}{Monitor-Chefe}{Nenhuma}


\cracha{Leticia}{da Silva Bomfim}{202}{Monitora}{Nenhuma}


\cracha{Jarol}{Vijay Butron Soria}{203}{Monitor}{Nenhuma}
