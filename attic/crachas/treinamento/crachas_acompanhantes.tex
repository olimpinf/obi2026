...
\newcommand\BackgroundPic{
  \put(12,110){
    \parbox[b][165mm]{105mm}{
      \vfill
      \centering
      \includegraphics[width=109mm,keepaspectratio]{FundoCrachaAmarelo.pdf}
      \vfill
    }
  }
}
...
\cracha{Greyce}{Graziely Coelho}{501}{Acompanhante}{Nenhuma}


\cracha{Ingrid}{Vasconcelos}{502}{Acompanhante}{Nenhuma}
