...
#where compet_medal in ('o','p','b') and
...
where f.compet_medal in ('o','p','b') and c.compet_id=f.compet_id and c.compet_school_id=s.school_id
group by school_id,
    school_deleg_name,
    school_name,
    school_address,
...
for data in bdata:
    ...
    toaddress['cpf']= ''
    toaddress['num_medals']=data['num_medals']
...
outputStream = open('declaracoes_conteudo_cf.pdf', "wb")
